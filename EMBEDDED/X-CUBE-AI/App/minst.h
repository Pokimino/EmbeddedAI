...
/******************************************************************************/
#define AI_MINST_MODEL_NAME          "minst"
#define AI_MINST_ORIGIN_MODEL_NAME   "mnist_nn_c2_16_10"

/******************************************************************************/
#define AI_MINST_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MINST_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MINST_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MINST_IN_NUM        (1)

AI_DEPRECATED
#define AI_MINST_IN \
  ai_minst_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MINST_IN_SIZE { \
  AI_MINST_IN_1_SIZE, \
}
#define AI_MINST_IN_SIZE_BYTES { \
  AI_MINST_IN_1_SIZE_BYTES, \
}
#define AI_MINST_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MINST_IN_1_HEIGHT      (28)
#define AI_MINST_IN_1_WIDTH       (28)
#define AI_MINST_IN_1_CHANNEL     (1)
#define AI_MINST_IN_1_SIZE        (784)
#define AI_MINST_IN_1_SIZE_BYTES  (3136)

/******************************************************************************/
#define AI_MINST_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MINST_OUT \
  ai_minst_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MINST_OUT_SIZE { \
  AI_MINST_OUT_1_SIZE, \
}
#define AI_MINST_OUT_SIZE_BYTES { \
  AI_MINST_OUT_1_SIZE_BYTES, \
}
#define AI_MINST_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MINST_OUT_1_CHANNEL     (10)
#define AI_MINST_OUT_1_SIZE        (10)
#define AI_MINST_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_MINST_N_NODES (5)
 ...
 * @ref ai_minst_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_minst_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MINST_*
 * defines into file @ref minst.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
