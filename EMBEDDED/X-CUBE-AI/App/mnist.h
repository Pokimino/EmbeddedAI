...
/******************************************************************************/
#define AI_MNIST_MODEL_NAME          "mnist"
#define AI_MNIST_ORIGIN_MODEL_NAME   "mnist_nn_c2_16_10"

/******************************************************************************/
#define AI_MNIST_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MNIST_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MNIST_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MNIST_IN_NUM        (1)

AI_DEPRECATED
#define AI_MNIST_IN \
  ai_mnist_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNIST_IN_SIZE { \
  AI_MNIST_IN_1_SIZE, \
}
#define AI_MNIST_IN_SIZE_BYTES { \
  AI_MNIST_IN_1_SIZE_BYTES, \
}
#define AI_MNIST_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNIST_IN_1_HEIGHT      (28)
#define AI_MNIST_IN_1_WIDTH       (28)
#define AI_MNIST_IN_1_CHANNEL     (1)
#define AI_MNIST_IN_1_SIZE        (784)
#define AI_MNIST_IN_1_SIZE_BYTES  (3136)

/******************************************************************************/
#define AI_MNIST_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MNIST_OUT \
  ai_mnist_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNIST_OUT_SIZE { \
  AI_MNIST_OUT_1_SIZE, \
}
#define AI_MNIST_OUT_SIZE_BYTES { \
  AI_MNIST_OUT_1_SIZE_BYTES, \
}
#define AI_MNIST_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNIST_OUT_1_CHANNEL     (10)
#define AI_MNIST_OUT_1_SIZE        (10)
 ...
 * @ref ai_mnist_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mnist_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MNIST_*
 * defines into file @ref mnist.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
